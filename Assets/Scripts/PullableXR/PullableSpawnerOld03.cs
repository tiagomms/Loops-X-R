...
namespace PullableXR
{
    ...
    /// </summary>
    public class PullableSpawnerOld03 : MonoBehaviour
    {
        ...
        //[Header("Meta XR Event Wrappers")]
        //[SerializeField] private List<InteractableUnityEventWrapper> interactableUnityEventWrappers;

        [Header("Events")]
        public UnityEvent onConfirm;
        public UnityEvent onCancel;

        private PullableInstanceOld03 activeInstance;
        ...
        public void TriggerPull(Transform handTransform)
        {
            ...
            activeInstance = spawned.AddComponent<PullableInstanceOld03>();
        ...
        public void Release()
        {
            if (activeInstance != null)
            {
                ...
                activeInstance.enabled = false; // Pullable Instance 
                activeInstance = null;
            }
        }
