...
namespace PullableXR
{
    ...
    /// </summary>
    public class PullableInstanceOld03 : MonoBehaviour
    {
        private PullableSpawnerOld03 spawner;
        ...
        /// </summary>
        public void Initialize(PullableSpawnerOld03 spawner, Transform instanceT, Vector3 initialPos, Transform handT, float confirmDistance, float minScale, float maxScale, float failedDuration, Ease failedEase, string temporaryLayerName)
        {
